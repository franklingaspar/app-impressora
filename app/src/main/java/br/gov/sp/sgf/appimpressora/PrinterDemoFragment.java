...
import br.gov.sp.sgf.appimpressora.adapter.ListViewAdapter;
import br.gov.sp.sgf.appimpressora.connection.Connection_Bluetooth;
import br.gov.sp.sgf.appimpressora.data.PrinterObject;
import br.gov.sp.sgf.appimpressora.dialog.CustomDialog;
 ...
 */
public class PrinterDemoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBtnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setTargetFragment(getParentFragment(), DIALOG_ADD_OBJECT);
